...
const expected = {
  ...
  'daybeat.js': [
    'delay', 'findElementHandle', 'normalizeText', 'listElements', 'collectAllItems',
  ...
  'flows/jira-config.js': ['connectJiraFlow', 'disconnectJiraFlow'],
  'flows/setup.js': ['runSetupWizard'],
  'app-config.js': [
    'initialize', 'load', 'reload', 'syncEnv', 'isSetupComplete',
    'getDaybeat', 'setDaybeat', 'getGit', 'setGit',
    'getHeadless', 'setHeadless', 'isJiraEnabled', 'setJiraEnabled', 'getStatus'
  ],
  'jira-report.js': ['isConfigured', 'getStatus', 'connectJira', 'disconnectJira', 'getDailyActivity', 'formatActivityForReport', 'closeConnection']
};
